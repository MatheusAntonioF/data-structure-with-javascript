...
describe('#getByIndex', () => {
  ...
  describe('with index greater than list length', () => {
    test('it returns null', () => {
      ...
      const INDEX_GREATER_THAN_LENGTH = 5;

      expect(ll.getByIndex(INDEX_GREATER_THAN_LENGTH)).toBeNull();
    });
  });

  describe('with index 0', () => {
    test('its returns the head', () => {
      const ll = LinkedList.fromValues(10, 20);
  ...
  describe('with index in the middle', () => {
    test('its returns the elements at that index', () => {
